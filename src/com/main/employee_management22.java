 ...
 * @author Chamika
 */
public class employee_management22 extends javax.swing.JPanel {

    /**
     * Creates new form Employee_Management1
     */
    public employee_management22() {
        initComponents();
...
//        reset();
    ...
    private void employee_load_image(){
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "First Name", "Last Name", "Email", "Mobile", "Username", "Position", "Status", "Gender", "Registerd_date"
            }
        ) {
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel3Layout.createSequentialGroup()
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(jTextField2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 245, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    MySQL.execute("INSERT INTO `employee`"
                            + "(`fname`,`lname`,`email`,`mobile`,`username`,`password`,`employee_position_id`,`status_id`,`gender_id`,`registerd_date`)"
                            + "VALUES('" + firstName + "','" + lastName + "','" + email + "','" + mobile + "','" + username + "','" + password + "',"
                            + "'" + EmployeePositionMap.get(position) + "','" + EmployeeStatusMap.get(status) + "','" + EmployeeGenderMap.get(gender) + "','" + date + "')");
//                    MySQL.execute("INSERT INTO `employee_image`(`url`,`empl")
...
//
//        // Set the image to jLabel8
//        jLabel8.setIcon(new ImageIcon(path));
//    }
 ...
 // Create a file chooser
    ...
    if (returnValue == JFileChooser.APPROVE_OPTION) {
        try {
            ...
            String targetDirPath = projectPath + "/src/punsisi/image";
